...
// 임시 공지사항 데이터 (나중에 실제 데이터로 수정하시면 됩니다)
const noticesData = [
  {
    id: 1,
    ...
    <div className="font-sans pt-24 min-h-screen flex flex-col bg-gray-50">
      <div className="flex-grow max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 pb-24">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          {/* 리스트 헤더 (PC에서만 보임) */}
          <div className="hidden md:flex bg-gray-50 px-6 py-4 border-b border-gray-200 text-sm font-semibold text-gray-500 text-center">
            <div className="w-24">번호</div>
            <div className="flex-grow text-left pl-4">제목</div>
            ...
            {noticesData.map((notice, index) => (
              <div key={notice.id} className="group">
                <button
                  ...
                  className="w-full flex flex-col md:flex-row items-start md:items-center px-6 py-5 hover:bg-rose-50/50 transition-colors duration-200 focus:outline-none text-left"
                >
                  <div className="hidden md:block w-24 text-center text-gray-400 font-light">
                    {noticesData.length - index}
                  </div>
                  <div className="flex-grow pr-4 md:pl-4 mb-2 md:mb-0">
                  ...
                  <div className="flex w-full md:w-auto items-center justify-between md:justify-center mt-2 md:mt-0">
                    <div className="md:w-32 text-left md:text-center text-sm text-gray-400 font-light">
                      {notice.date}
                    </div>
                ...
                >
                  <div className="p-6 md:p-10 md:ml-24 text-gray-600 leading-relaxed whitespace-pre-wrap font-light border-l-2 border-rose-600 ml-6 my-4">
                    {notice.content}
                  </div>
                </div>
              </div>
