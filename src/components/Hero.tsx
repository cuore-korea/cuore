        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center group">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">천연 성분</h3>
              <p className="text-gray-600 font-light">자연에서 온 순수한 성분으로 피부를 케어합니다</p>
            </div>
